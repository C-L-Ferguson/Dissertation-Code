...
```{r New York Analysis}
NY_Merged_Data$Contested_Primary[is.na(NY_Merged_Data$Contested_Primary)] <- 0
NY_Merged_Data$Did_Incumbent_Seek_Reelection[is.na(NY_Merged_Data$Did_Incumbent_Seek_Reelection)] <- 0
...
# do this separated by decarceratory and not. REMEMBER THOUGH I NEED THE DECARCERATORY DA TO BE SEEKING REELECTION.
...
NY_Decarceratory_Model_Jail <-lm(Percentage_Jail ~ Contested_Primary, data = NY_Decarceratory) 

stargazer(NY_Decarceratory_Model_Jail,  title = "Jail by Contested Primary Decarceratory DAs") %>% write_lines("NY_Decarceratory_Model_Jail.txt")

NY_Decarceratory_Model_Probation <- 
  lm(Percentage_Probation ~ Contested_Primary, data = NY_Decarceratory)

stargazer(NY_Decarceratory_Model_Probation,  title = "Probation by Contested Primary Decarceratory DAs") %>%
  write_lines("NY_Decarceratory_Model_Probation.txt")

NY_Decarceratory_Model_Fine <- 
  lm(Percentage_Fine ~ Contested_Primary, data = NY_Decarceratory)

stargazer(NY_Decarceratory_Model_Fine,  title = "Fine by Contested Primary Decarceratory DAs") %>%
  write_lines("NY_Decarceratory_Model_Fine.txt")

NY_Decarceratory_Prison <- 
  lm(Percentage_Prison ~ Contested_Primary, data = NY_Decarceratory)

stargazer(NY_Decarceratory_Prison,  title = "Prison by Contested Primary Decarceratory DAs") %>%
  write_lines("NY_Decarceratory_Prison.txt")


NY_NonDecarceratory_Model_Jail <- lm(Percentage_Jail ~ Contested_Primary, data = NY_NonDecarceratory)

stargazer(NY_NonDecarceratory_Model_Jail, title = "Jail by Contested Primary NonDecarcreatory DAs") %>%
  write_lines("NY_NonDecareratory_Jail.txt")
...
ggsave(CA_Box_Plot_2, file = "C:/Users/carol/Desktop/Dissertation Code/Dissertation-Code/Chapter 2 Visuals/CAboxplot2Ch2.png")
#is there a correlation between probation and prison
