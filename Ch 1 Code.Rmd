...
# Calculate and add new columns with averages

# CO_averages_before_2006_yes <- colMeans(CO_before_2006_yes_vote[, 12:24])
# 
# CO_averages_before_2006_yes <- data.frame(CO_averages_before_2006_yes)
# 
# CO_averages_before_2006_yes <- t(CO_averages_before_2006_yes)
# 
# CO_averages_before_2006_yes <- data.frame(CO_averages_before_2006_yes)
# 
# CO_averages_before_2006_no <- colMeans(CO_before_2006_no_vote[, 12:24])
# 
# CO_averages_before_2006_no <- data.frame(CO_averages_before_2006_no)
# 
# CO_averages_before_2006_no <- t(CO_averages_before_2006_no)
# 
# CO_averages_before_2006_no <- data.frame(CO_averages_before_2006_no)
# 
# 
# CO_averages_after_2006_yes <- colMeans(CO_after_2006_yes_vote[, 12:24])
# 
# CO_averages_after_2006_yes <- data.frame(CO_averages_after_2006_yes)
# 
# CO_averages_after_2006_yes <- t(CO_averages_after_2006_yes)
# 
# CO_averages_after_2006_yes <- data.frame(CO_averages_after_2006_yes)
# 
# 
# CO_averages_after_2006_no <- colMeans(CO_after_2006_no_vote[, 12:24])
# 
# CO_averages_after_2006_no <- data.frame(CO_averages_after_2006_no)
# 
# CO_averages_after_2006_no <- t(CO_averages_after_2006_no)
# 
# CO_averages_after_2006_no <- data.frame(CO_averages_after_2006_no)
# 
# 
# 
# #now I can compare these numbers I think. P values of 1 seem a bit extreme here. I think I did something wrong
# 
# t.test(CO_averages_before_2006_yes , CO_averages_after_2006_yes , paired = T)
# 
# wilcox.test(CO_averages_before_2006_yes %>%
#             select(rc_rate) %>%
#               unlist , CO_averages_before_2006_no %>%
#   select(rc_rate) %>%
#   unlist)
# 
# wilcox.test(CO_averages_after_2006_yes %>%
#             select(rc_rate) %>%
#               unlist , CO_averages_after_2006_no %>%
#   select(rc_rate) %>%
#   unlist)
# 
# 
