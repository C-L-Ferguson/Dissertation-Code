...
ggsave(NY_Box_Plot_2, file = "C:/Users/carol/Desktop/Dissertation Code/Dissertation-Code/Images/CAboxplot2.png")
#is there a correlation between probation and prison
...
combined_t <- 
  tab_row_group(data = CA_Merged_Data_Model_Prison, label = "Group 1", rows = 1) %>%
  tab_row_group(data = CA_Merged_Data_Model_Probation, label = "Group 2", rows = 2)
