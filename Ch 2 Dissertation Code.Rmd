...
NY_Merged_Data %>%
  ...
  geom_signif(comparisons = list(c("Percentage_Prison", "Election_Year")) , 
...
Percentage_Prison <- NY_Merged_Data$Percentage_Prison
Contested_Primary <- NY_Merged_Data$Contested_Primary
Percentage_Jail <- NY_Merged_Data$Percentage_Jail
Percentage_Probation <- NY_Merged_Data$Percentage_Probation
Percentage_Fine <- NY_Merged_Data$Percentage_Fine

NY_Merged_Data_Model_Jail <- 
  lm(Percentage_Jail ~ Contested_Primary)


NY_Merged_Data_Model_Probation <- 
  lm(Percentage_Probation ~ Contested_Primary)


NY_Merged_Data_Model_Fine <- 
  lm(Percentage_Fine ~ Contested_Primary)


NY_Merged_Data_Model_Prison <- 
  lm(Percentage_Prison ~ Contested_Primary)
