...
CA_Prison_Sentences_by_Decarceratory <- aov(data = California_Merged_Data , Percentage_Prison ~ Decarceratory.)
...
wilcox.test(California_Merged_Data %>%
              filter(Decarceratory. == 1) %>%
              select(Percentage_Prison) %>%
              na.omit %>%
              unlist, 
            California_Merged_Data %>%
              filter(Decarceratory. == 0) %>%
              select(Percentage_Prison) %>%
              na.omit %>%
              unlist)
...
med1way(data = California_Merged_Data ,
        Percentage_Prison ~ Decarceratory.)

med2way(data = California_Merged_Data ,
...
cor.test(data = California_Merged_Data , 
